...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        true_image = PhotoImage(file="C:/Python/100_days_of_coding/1_100__Days/Day_34/images/true.png")
        self.true_button = Button(image=true_image, highlightthickness=0, command=self.true_pressed)
        self.true_button.grid(row=2, column=0)

        false_image = PhotoImage(file="C:/Python/100_days_of_coding/1_100__Days/Day_34/images/false.png")
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text="You've reached then end of the quiz.")
